        ...
        <header className="bg-white border-b px-6 py-4 sticky top-0 z-30">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Aylık istatistikler ve analizler</p>
            </div>
            <select
              value={selectedAy}
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
              <p className="text-gray-500 text-xs">Toplam Gelin</p>
              <p className="text-3xl font-bold text-pink-600">{ayGelinler.length}</p>
            </div>
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
              <p className="text-gray-500 text-xs">İşlenmemiş</p>
              <p className="text-3xl font-bold text-gray-400">{islenmemis}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100">
                <h2 className="font-semibold text-gray-800">👥 Personel Performansı</h2>
              </div>
              <div className="p-4">
                  ...
                  {personelRapor.map((p, index) => (
                    <div key={p.id} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <span className="font-medium text-gray-800">{p.isim}</span>
                          <span className="font-bold text-pink-600">{p.toplam}</span>
                        </div>
                        <div className="flex gap-2 mt-1">
                          <span className="text-xs text-pink-500">Makyaj: {p.makyaj}</span>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100">
                <h2 className="font-semibold text-gray-800">📅 Haftalık Dağılım</h2>
              </div>
              <div className="p-4">
                <div className="space-y-3">
                  {gunDagilimi.map((gun) => (
                    <div key={gun.gun} className="flex items-center gap-3">
                      <span className="text-sm text-gray-600 w-24">{gun.gun}</span>
                      <div className="flex-1">
