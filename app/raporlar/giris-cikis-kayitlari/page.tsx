    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:ml-64 pb-20 md:pb-0">
        <header className="bg-white border-b px-4 md:px-6 py-4 sticky top-0 z-30">
          <h1 className="text-xl font-bold text-gray-800">Giriş ve Çıkış Kayıtları</h1>
          <p className="text-sm text-gray-500 mt-1">Bu sayfada, belirlediğiniz parametrelere göre "Giriş ve Çıkış Kayıtları" raporunu görüntüleyebilirsiniz.</p>
        </header>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">İşlem Türü</th>
